...
// its useful for sima  fating reading a variable number of bytes per chunk from a network connection
...
func TestHeaderParse(t *testing.T) {
	...
	userAget, _ := r.Headers.Get("user-agent")
	assert.Equal(t, "curl/7.81.0", userAget)
